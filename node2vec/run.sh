...
$SPARK_HOME/bin/spark-submit \
    ...
    --input "/home/kim/workspace/python/synthethic_AML_detection/data/output/data/edges" --output "/home/kim/workspace/python/synthethic_AML_detection/data/output/data/node2vec" --cluster --partitions 1 --numwalks 5 --p 1.0 --q 1.0 --weighted --degree 30 --indexed --cmd "randomwalk" --walklength 40 --nodepath ""
